...
export default function DashboardPage() {
  ...
  const [userUsage, setUserUsage] = useState<UserUsage>({ monthlyClones: 0, usedClones: 0 });
  ...
  const canCreateProject = () => {
    ...
    return userUsage.usedClones < limit;
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!canCreateProject()) {
      setError('You have reached your monthly clone limit. Please upgrade your plan to continue.');
      return;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <SubscriptionStatus 
              usedClones={userUsage.usedClones}
              monthlyClones={userUsage.monthlyClones}
            />
          </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex-shrink-0 text-right">
                      ...
                      <Link
                        ...
                        className={`mt-2 inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md transition-colors ${
                          project.status === 'COMPLETED'
                            ? 'text-blue-700 bg-blue-100 hover:bg-blue-200'
                            : 'text-gray-700 bg-gray-100 hover:bg-gray-200'
                        }`}
                      >
                        {project.status === 'COMPLETED' ? 'View & Download' : 'View Progress'}
                      </Link>
                    </div>
                  </div>
